export default function Hero() {
  return (
    <section id="hero" className="relative overflow-hidden bg-gradient-to-r from-[#0B1E4A] via-[#153A82] to-[#1E4FA2] text-white">
        ...
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-5xl md:text-6xl font-bold leading-tight">
              ReAuto: <span className="text-blue-100">Repuestos, Accesorios y Más</span>
            </h1>
            ...
            <div className="flex flex-col gap-4 pt-4 sm:flex-row">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-white px-8 py-4 font-bold text-[#0B1E4A] transition hover:bg-blue-50"
              >
              ...
              <a
                href="#servicios"
                className="inline-flex items-center justify-center gap-2 rounded-lg border border-white/30 bg-white/10 px-8 py-4 font-bold text-white backdrop-blur-sm transition hover:bg-white/20"
              >
                Explorar catálogo
          ...
          <div className="relative hidden md:block">
            <div className="rounded-2xl border border-white/20 bg-white/10 p-8 backdrop-blur-sm">
              <div className="flex h-96 items-center justify-center rounded-xl bg-gradient-to-br from-blue-200 to-slate-200">
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0,50 Q360,0 720,50 T1440,50 L1440,120 L0,120 Z" fill="#f8fafc" />
        </svg>
      </div>
